defmodule Pento.Catalog do
  ...
  This module is responsible for doing some shit...
  """
  ...
  @doc """
  Decrease products price and write changes to the database
  ...
  # def products_by_gender(%{gender_filter: gender_filter, gender_filter: gender_filter}) do
  #   Product.Query.with_average_ratings()
  #   |> Product.Query.join_users()
  #   |> Product.Query.join_demographics()
